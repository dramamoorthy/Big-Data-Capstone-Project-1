...
show_menu
    ...
    if [[ $opt = "" ]]; then 
	   ...
	   pig /home/hduser/Desktop/project/pig/1b.pig
	...
	echo -e "6) Find the percentage and the count of each case status on total applications for each year. Create a graph depicting the pattern of All the cases over the period of time.";
		pig  /home/hduser/Desktop/project/pig/6.pig
		...
		pig /home/hduser/Desktop/project/pig/9.pig
        show_menu;
        ;;
		13) clear;
		...
		pig /home/hduser/Desktop/project/pig/10.pig
